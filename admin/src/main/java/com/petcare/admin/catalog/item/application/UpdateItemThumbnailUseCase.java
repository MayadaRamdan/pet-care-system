...
@Transactional
@AllArgsConstructor
public class UpdateItemThumbnailUseCase {

  private final ItemRepository itemRepository;
  private final UploadAssetUseCase uploadAssetUseCase;

  public void execute(Long itemId, MultipartFile thumbnailMultipart) throws IOException {
    ...
    itemRepository.updateThumbnail(itemId, thumbnail, thumbnail.getUrl());
  }
}
